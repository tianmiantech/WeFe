<template>
    <div class="xx">
        ...
        >
            ...
            >
                <template slot-scope="scope">
                    <router-link :to="{name: 'modeling-config-view', query: { id: scope.row.id, algorithm:'LogisticRegression' }}">
...
export default {
    ...
    methods: {
        getDataList() {
            this.getListApi = '/modeling_config/query?algorithm=LogisticRegression';
            this.getList();
        },
        // 删除
        deleteData(row) {
