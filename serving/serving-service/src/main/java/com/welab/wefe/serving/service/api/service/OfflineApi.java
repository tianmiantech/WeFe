...
@Api(path = "service/offline", name = "offline service")
public class OfflineApi extends AbstractApi<OfflineApi.Input, OfflineApi.Output> {
	...
	protected ApiResult<Output> handle(Input input) throws StatusCodeWithException, IOException {
		serviceService.offlineService(input.getId());
		return success();
	}
