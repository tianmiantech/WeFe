...
@Api(path = "partner/query-all", name = "get partner list")
public class QueryPartnerAllApi extends AbstractNoneInputApi<List<QueryPartnerAllApi.Output>> {

    @Autowired
    private PartnerService partnerService;

    @Override
    protected ApiResult<List<QueryPartnerAllApi.Output>> handle() {
        return success(partnerService.queryAll());
    }
