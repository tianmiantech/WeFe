 ...
 * @author hunter.zhao
 */
public class ProviderPredicter extends AbstractProviderPredicter {

    public ProviderPredicter(FederatedParams federatedParams, PredictParams predictParams, JSONObject params) {
