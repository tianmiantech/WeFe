...
import com.welab.wefe.serving.service.database.entity.GlobalSettingMySqlModel;
 ...
 */
@Repository
public interface GlobalSettingRepository extends BaseRepository<GlobalSettingMySqlModel, String> {

    /**
     * Find the singleton
     *
     * @return GlobalSettingMySqlModel
     */
