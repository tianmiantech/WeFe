...
from kernel.components.binning.core.quantile_summaries import QuantileSummaries
...
"""
Tips：
    There is already "statistics.py" extended based on this component to replace this component. 
    Developers are requested to use statistics.py for subsequent development as much as possible.
"""
...
class SummaryStatistics(object):
    ...
    def add_value(self, value, col_index, cols_dict):
...
class MultivariateStatisticalSummary(object):
    ...
    def _static_sums(self):
        """
        Statics sum, sum_square, max_value, min_value, so that variance is available.
        """
    ...
    def static_in_partition(data_instances, cols_dict, abnormal_list):
        ...
        for k, instances in data_instances:
            ...
            for col_name, col_index in cols_dict.items():
                ...
                stat_obj.add_value(value, col_index, cols_dict)
