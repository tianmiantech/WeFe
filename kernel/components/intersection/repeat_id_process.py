...
class RepeatedIDIntersect(object):
    ...
    def run(self, data):
        ...
        id_map_federation = self.transfer_variable.id_map_from_promoter
        party_role = consts.PROVIDER
        if self.repeated_id_owner == consts.PROVIDER:
            id_map_federation = self.transfer_variable.id_map_from_provider
            party_role = consts.PROMOTER
