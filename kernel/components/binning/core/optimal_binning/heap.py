...
from kernel.components.binning.core.optimal_binning.bucket_info import Bucket
from kernel.components.binning.vertfeaturebinning.param import OptimalBinningParam
...
class IvHeapNode(HeapNode):
    ...
    def cal_score(self):
        ...
        event_rate, non_event_rate, merge_woe = binning_util.calc_woe(self)
