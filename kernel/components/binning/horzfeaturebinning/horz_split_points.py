...
from kernel.transfer.framework.horz.blocks import secure_mean_aggregator
...
class HorzFeatureBinningServer(object):
    def __init__(self):
...
class HorzFeatureBinningClient(object):
    ...
    def average_run(self, data_instances, bin_param: FeatureBinningParam = None, bin_num=10, abnormal_list=None):
        ...
        if self.bin_method == consts.QUANTILE:
            ...
            raise ValueError("Horz Split Point do not accept bin_method: {}".format(self.bin_method))
