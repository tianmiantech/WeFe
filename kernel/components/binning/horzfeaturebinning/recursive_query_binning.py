...
class Server(horz_binning_base.Server):
    def __init__(self, params: HorzFeatureBinningParam, abnormal_list=None):
...
class Client(horz_binning_base.Client):
    def __init__(self, role, params: HorzFeatureBinningParam = None,
    ...
    def _recursive_querying(self, summary_table):
        self.set_suffix(-1)
        query_points_table = binning_util.init_query_points(self, summary_table._partitions,
