...
from kernel.transfer.framework.weights import OrderDictWeights, Weights
from kernel.components.deeplearning.backend.tf_keras import losses
from kernel.components.deeplearning.horznn.nn_model import DataConverter, NNModel
...
class KerasNNModel(NNModel):
    ...
    def get_forward_loss_from_input(self, X, y):
        from kernel.components.deeplearning.vertnn.backend.tf_keras import losses
    ...
    def restore_model(
        ...
        try:
            ...
            # add custom objects
            from kernel.components.deeplearning.vertnn.backend.tf_keras.losses import (
                keep_predict_loss,
            )
