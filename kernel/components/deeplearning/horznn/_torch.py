...
from common.python.utils.non_distributed import LocalData
from kernel.components.deeplearning.backend.pytorch.data import TableDataSet, VisionDataSet
from kernel.components.deeplearning.backend.pytorch.layer import get_layer_fn
from kernel.components.deeplearning.backend.pytorch.loss import get_loss_fn
from kernel.components.deeplearning.backend.pytorch.optimizer import get_optimizer
from kernel.components.deeplearning.horznn import _consts
from kernel.components.deeplearning.horznn.horz_nn_param import HorzNNParam
from kernel.protobuf.generated import nn_model_meta_pb2, nn_model_param_pb2
from kernel.transfer.framework.horz.blocks import aggregator, random_padding_cipher
from kernel.transfer.framework.horz.blocks.secure_aggregator import SecureAggregatorTransVar
from kernel.utils.horz_label_encoder import HorzLabelEncoderArbiter
...
def build_aggregator(param: HorzNNParam):
