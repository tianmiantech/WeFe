...
class SelectorParam(object):
    """
    Parameters used for Horz Neural Network.
...
class VertNNParam(BaseParam):
    """
    Parameters used for Vert Neural Network.

    Args:
        task_type: str, task type of vert nn model, one of 'classification', 'regression'.
        ...
        optimizer: optimizer method, accept following types:
            ...
            2. a dict, with a required key-value pair keyed by "
            optimizer",
    ...
    def __init__(self,
        ...
        super(VertNNParam, self).__init__()
