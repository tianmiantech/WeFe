...
from kernel.components.featurecalculation.param import ManuallyFilterParam
...
class ManuallyFilter(BaseFilterMethod):
    ...
    def fit(self, data_instances, suffix):
        ...
        for col_idx, col_name in zip(self.calculation_properties.calculate_col_indexes,
    ...
    def get_meta_obj(self, meta_dicts):
        result = feature_calculation_meta_pb2.ManuallyFilterMeta(filter_out_names=self.filter_out_names)
