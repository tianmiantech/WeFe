...
import numpy as np
from kernel.components.featurecalculation.base.selection_properties import SelectionProperties

from common.python import session
from kernel.components.featurecalculation.base.filter_factory import get_filter
...
class TestVarianceCoeFilter(unittest.TestCase):
    ...
    def test_unique_logic(self):
        ...
        select_param = FeatureCalculationParam()
