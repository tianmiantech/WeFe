...
import numpy as np
from kernel.feature.feature_selection.filter_factory import get_filter
from kernel.feature.feature_selection.selection_properties import SelectionProperties
from kernel.param.feature_selection_param import FeatureSelectionParam
from kernel.util import consts
...
class TestUniqueValueFilter(unittest.TestCase):
    ...
    def test_unique_logic(self):
        ...
        select_properties.set_calculate_all_cols()
