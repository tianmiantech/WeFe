...
from kernel.examples.handler.component import VertKmeans
...
def main(config="../../config.yaml", param="./alg_config.yaml", namespace="wefe_data"):
    # obtain config
    ...
    vert_kmeans_0 = VertKmeans(name="vert_kmeans_0", **kmeans_param)
    ...
    handler.add_component(vert_kmeans_0, data=Data(train_data=intersection_0.name))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("vert kmeans JOB")
    parser.add_argument("-c", "--config", type=str,
                        help="config file", default="../../../config.yaml")
    parser.add_argument("-p", "--param", type=str,
                        help="config file for params", default="./alg_config.yaml")
