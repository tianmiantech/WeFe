...
def main(config="../../config.yaml", param="./config.yaml", namespace="wefe_data"):
    ...
    feature_transform_params = {
        "transform_rules": "{\"gender\":{\"Female\":1,\"Male\":0,\"Other\":-1},\"ever_married\":{\"Yes\":1,\"No\":0},\"work_type\":{\"Private\":0,\"Self-employed\":1,\"children\":2,\"Govt_job\":3,\"Never_worked\":4},\"Residence_type\":{\"Urban\":0,\"Rural\":1},\"smoking_status\":{\"never smoked\":0,\"Unknown\":1,\"formerly smoked\":2,\"smokes\":3}}"
    }

    feature_transform_0 = Transform(name="transform_0", **feature_transform_params)
    ...
    handler.add_component(feature_transform_0, data=Data(data=dataio_0.name), output_data_type=["train"])
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("Feature Transform JOB")
