...
from kernel.examples.handler.component import HorzPearson
...
def main(config="../../config.yaml", param="./config.yaml", namespace="wefe_data"):
    ...
    pearson_params = {
        'column_names': ['x0', 'x1', 'x2', 'x3', 'x4', 'x5', 'x6', 'x7', 'x8', 'x9', 'x10', 'x11', 'x12', 'x13', 'x14',
                         'x15', 'x16', 'x17', 'x18', 'x19', 'x20', 'x21', 'x22', 'x23', 'x24', 'x25', 'x26', 'x27',
                         'x28',
                         'x29']}

    horz_pearson = HorzPearson(name='horz_pearson_0', **pearson_params)
    ...
    handler.add_component(horz_pearson, data=Data(train_data=dataio_0.name))
