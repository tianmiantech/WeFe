...
from kernel.examples.handler.component import DataIO, VertPCA
...
def main(config="../../config.yaml", param="./config.yaml", namespace="wefe_data"):
    ...
    vert_pca_0 = VertPCA(name="vert_pca_0", **pca_param)
    ...
    handler.add_component(vert_pca_0, data=Data(train_data=intersection_0.name))
...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", "--param", type=str,
                        help="config file for params", default="./pca_config.yaml")
