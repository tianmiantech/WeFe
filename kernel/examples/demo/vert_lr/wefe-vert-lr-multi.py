...
def main(config="../../config.yaml", param="./multi_config.yaml", namespace="wefe_data"):
    # obtain config
    ...
    # initialize handler
    handler = Handler(job_id="job_0003", backend=backend, work_mode=work_mode, db_type=db_type, fl_type='vertical')
    # set job initiator
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("MULTI VERT LR JOB")
