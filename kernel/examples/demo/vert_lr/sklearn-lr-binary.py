...
def main(config="../../config.yaml", param="./binary_config.yaml"):
    ...
    ks = max(tpr - fpr)
    result = {"auc": auc_score, "ks": ks, "recall": recall, "precision": pr, "accuracy": acc}
    print(result)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("LR BINARY SKLEARN JOB")
    parser.add_argument("-p", "--param", type=str, default="./binary_config.yaml",
