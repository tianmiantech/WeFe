...
from kernel.examples.handler.component import Scorecard
...
def main(config="../../../config.yaml", param="./lr_config.yaml", namespace="wefe_data"):
    ...
    scorecard_0 = Scorecard(name='scorecard_0', **scorecard_parm)

    evaluation_0 = Evaluation(name='evaluation_0')
    evaluation_0.get_member_instance(role='promoter', member_id=promoter).component_param(need_run=True,eval_type="binary")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("WEFE HORZ SORCE BINARY JOB")
