...
class MixStatistic(Component, MixStatisticParam):
    def __init__(self, **kwargs):
        ...
        MixStatisticParam.__init__(self, **new_kwargs)
        self.input = Input(self.name, data_type="multi")
        self.output = Output(self.name)
        self._module_name = "mixstatistic"
        self._param_name = "MixStatisticParam"
