...
class VertScaleParameter(VertFeatureScaleParam):
...
class VertScale(Component, VertScaleParameter):
    def __init__(self, **kwargs):
        ...
        VertScaleParameter.__init__(self, **new_kwargs)

        self.input = Input(self.name)
        self.output = Output(self.name, data_type='single')
        self._module_name = "VertScale"
        self._param_name = "VertFeatureScaleParam"
