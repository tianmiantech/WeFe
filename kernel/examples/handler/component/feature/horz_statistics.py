...
class HorzStatistic(Component, HorzStatisticParam):
    def __init__(self, **kwargs):
        ...
        HorzStatisticParam.__init__(self, **new_kwargs)
        self.input = Input(self.name, data_type="single")
        self.output = Output(self.name)
        self._module_name = "HorzStatistic"
        self._param_name = "HorzStatisticParam"
