...
class VertStatisticParameter(FeatureStatisticParam):
...
class VertStatistic(Component, VertStatisticParameter):
    def __init__(self, **kwargs):
        ...
        VertStatisticParameter.__init__(self, **new_kwargs)

        self.input = Input(self.name)
        self.output = Output(self.name, data_type='single')
        self._module_name = "Featurestatistic"
        self._param_name = "FeatureStatisticParam"
