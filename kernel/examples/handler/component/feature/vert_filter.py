...
class VertFilterParameter(VertSampleFilterParam):
...
class VertFilter(Component, VertFilterParameter):
    def __init__(self, **kwargs):
        ...
        VertFilterParameter.__init__(self, **new_kwargs)

        self.input = Input(self.name)
        self.output = Output(self.name, data_type='single')
        self._module_name = "VertFilter"
        self._param_name = "VertSampleFilterParam"
