...
class VertFastSecureBoost(Component, VertFastSecureBoostParam):
    def __init__(self, **kwargs):
        ...
        VertFastSecureBoostParam.__init__(self, **new_kwargs)
        self.input = Input(self.name, data_type="multi")
        self.output = Output(self.name)
        self._module_name = "VertFastSecureBoost"
        self._param_name = "VertFastSecureBoostParam"
