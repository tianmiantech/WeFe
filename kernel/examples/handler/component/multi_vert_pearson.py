...
from kernel.components.correlation.multivertpearson.param import PearsonParam
...
class MultiVertPerson(Component, PearsonParam):
    def __init__(self, **kwargs):
        ...
        self._module_name = "MultiVertPearson"
        self._param_name = "PearsonParam"
