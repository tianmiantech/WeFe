...
class Segment(Component, SegmentParam):
    def __init__(self, **kwargs):
        ...
        SegmentParam.__init__(self, **new_kwargs)
        self.input = Input(self.name)
        self.output = Output(self.name, data_type="multi", has_model=False)
        self._module_name = "Segment"
        self._param_name = "SegmentParam"
