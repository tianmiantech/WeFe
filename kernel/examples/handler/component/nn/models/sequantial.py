...
def _build_model(type):
    if type == "keras":
        from kernel.examples.handler.component.nn.backend.keras import model_builder
        return model_builder.build_model()

    if type == "pytorch":
        from kernel.examples.handler.component.nn.backend.pytorch import model_builder
        return model_builder.build_model()

    if type == "nn":
        from kernel.examples.handler.component.nn.backend.tf import model_builder
        return model_builder.build_model()
