...
class FillMissValueParameter(Params):
...
class FillMissValue(Component, FillMissValueParameter):
    def __init__(self, **kwargs):
        ...
        FillMissValueParameter.__init__(self, **new_kwargs)

        self.input = Input(self.name)
        self.output = Output(self.name, data_type='single')
        self._module_name = "FillMissingValue"
        self._param_name = "Params"
