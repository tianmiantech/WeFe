...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=b'\n\x18pearson-model-meta.proto\x12\"com.welab.wefe.core.mlmodel.buffer\"\"\n\x10PearsonModelMeta\x12\x0e\n\x06shapes\x18\x01 \x03(\x05\x42\x17\x42\x15PearsonModelMetaProtob\x06proto3'
)

_PEARSONMODELMETA = _descriptor.Descriptor(
    name='PearsonModelMeta',
    full_name='com.welab.wefe.core.mlmodel.buffer.PearsonModelMeta',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name='shapes', full_name='com.welab.wefe.core.mlmodel.buffer.PearsonModelMeta.shapes', index=0,
...
PearsonModelMeta = _reflection.GeneratedProtocolMessageType('PearsonModelMeta', (_message.Message,), {
    ...
    # @@protoc_insertion_point(class_scope:com.welab.wefe.core.mlmodel.buffer.PearsonModelMeta)
})
