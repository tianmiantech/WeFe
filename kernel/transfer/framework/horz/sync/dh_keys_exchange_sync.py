...
from kernel.transfer.framework.horz.util.scatter import Scatter
from kernel.transfer.variables.base_transfer_variable import Variable
...
class Arbiter(object):
    ...
    def register_dh_key_exchange(self,
                                 ...
                                 dh_ciphertext_provider_trv: Variable,
                                 dh_ciphertext_promoter_trv: Variable,
                                 dh_ciphertext_bc_trv: Variable):
        self._dh_pubkey_trv = dh_pubkey_trv
        self._dh_pubkey_scatter = Scatter(dh_ciphertext_provider_trv, dh_ciphertext_promoter_trv)
