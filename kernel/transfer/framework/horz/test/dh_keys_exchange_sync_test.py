...
from kernel.transfer.framework.horz.sync import identify_uuid_sync, dh_keys_exchange_sync
    ...
    def call(cls, role, transfer_variable, ind, *args):
        if role == consts.ARBITER:
            identify_uuid_sync.Arbiter() \
                .register_identify_uuid(transfer_variable.promoter_uuid,
