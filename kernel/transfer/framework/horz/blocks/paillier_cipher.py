...
from kernel.security.paillier import PaillierPublicKey
...
class PaillierCipherTransVar(HorzTransferBase):
    def __init__(self, server=(consts.ARBITER,), clients=(consts.PROVIDER,), prefix=None):
    ...
    def re_cipher(self, iter_num, re_encrypt_times, ciphers, re_encrypt_batches, suffix=tuple()):
        ...
        while total > 0:
            ...
            for party in party_remained:
                ...
                LOGGER.debug("Decrypted provider model is : {}".format(decrypt_model))
