...
from kernel.transfer.framework.vert.sync import batch_info_sync

LOGGER = log_utils.get_logger()


class Promoter(batch_info_sync.Promoter):
    def __init__(self):
        self.mini_batch_obj = None
        self.finish_sycn = False
        self.batch_nums = None

    def register_batch_generator(self, transfer_variables, has_arbiter):
...
class Provider(batch_info_sync.Provider):
    def __init__(self):
        self.finish_sycn = False
