...
class Promoter(object):
    def _register_loss_sync(self, provider_loss_regular_transfer, loss_transfer, loss_intermediate_transfer):
    ...
    def get_provider_loss_intermediate(self, suffix=tuple()):
...
class Provider(object):
    ...
    def remote_loss_intermediate(self, loss_intermediate, suffix=tuple()):
        self.loss_intermediate_transfer.remote(obj=loss_intermediate, role=consts.PROMOTER, idx=0, suffix=suffix)

    def remote_loss_regular(self, loss_regular, suffix=tuple()):
        self.provider_loss_regular_transfer.remote(obj=loss_regular, role=consts.PROMOTER, idx=0, suffix=suffix)
