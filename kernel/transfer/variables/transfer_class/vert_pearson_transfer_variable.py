...
class VertPearsonTransferVariable(BaseTransferVariables):
    def __init__(self, flowid=0):
        ...
        self.promoter_feature_select = self._create_variable(name='promoter_feature_select')
        ...
        self.provider_feature_select = self._create_variable(name='provider_feature_select')
