...
class SecureSumAggregatorTransVar(BaseTransferVariables):
    def __init__(self, flowid=0):
        ...
        self.AggregatorTransVar.ModelBroadcasterTransVar.server_model = self._create_variable(
            name='AggregatorTransVar.ModelBroadcasterTransVar.server_model')
        self.AggregatorTransVar.ModelScatterTransVar.client_model = self._create_variable(
            name='AggregatorTransVar.ModelScatterTransVar.client_model')
