 ...
 * @author aaron.li
 **/
public class PushDataSourceResponseStreamObserver implements StreamObserver<GatewayMetaProto.TransferMeta> {
    private final Logger LOG = LoggerFactory.getLogger(PushDataSourceResponseStreamObserver.class);
    ...
    public PushDataSourceResponseStreamObserver(SettableFuture<Void> finishFuture, AbstractTransferMetaDataSource.AsyncResponseCollector asyncResponseCollector) {
