...
mv serving/serving-service/target/serving-service.jar serving/serving-service/target/wefe-serving-service.jar
...
{
    "targetPath": "${workdir}/serving/serving-service/target"
}
EOF
