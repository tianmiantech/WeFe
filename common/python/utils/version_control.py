...
from common.python.utils.core_utils import json_loads, json_dumps, bytes_to_string
...
def save_version(name, namespace, version_log='', tag=None, branch=None):
    try:
        ...
        save_version_info(commit_id=name, data_table_namespace=namespace, version_log=version_log, tag=tag,
                          branch=branch)
        return True
