...
public class CurrentAccountUtil {
    ...
    public static void set(HttpServletRequest httpServletRequest) {
        ...
        AccountInfo2 accountInfo = buildAccountInfo(userId, userName, phoneNumber);
     ...
     * 创建用户
     */
    private static AccountInfo2 buildAccountInfo(String id, String name, String phoneNumber) {
