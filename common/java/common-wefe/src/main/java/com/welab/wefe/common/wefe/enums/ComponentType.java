...
import static com.welab.wefe.common.wefe.enums.FederatedLearningType.*;
...
public enum ComponentType {
    ...
    HorzNN("横向深度学习", Arrays.asList(FederatedLearningType.horizontal), "横向 深度学习 建模"),
    VertNN("纵向深度学习", Arrays.asList(FederatedLearningType.vertical), "纵向 深度学习 建模"),
