...
class JobWaitSuccessAction:
    logger = LoggerFactory.get_logger("JobWaitSuccessAction")
    """
    When all tasks have run successfully, this action will be entered and the Job will be set to wait_success.
    """
    job: Job
    ...
    def do(self, message):
        ...
        # Change from running to wait_success
        self.job.status = JobStatus.WAIT_SUCCESS
