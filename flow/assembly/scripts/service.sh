...
export PYTHONPATH=/opt/welab/wefe-flow
export SPARK_HOME=/opt/welab/spark-3.0.1-bin-hadoop2.7
# export PYSPARK_PYTHON=/data/spark-2.4.5-bin-hadoop2.7/python
PYTHON_ROOT=/opt/welab/wefe-flow
log_dir=/data/logs/wefe-flow
venv=/opt/welab/miniconda3/envs/wefe-python37
