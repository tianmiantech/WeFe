...
contract DataSetDefaultTagContract{
    ...
    constructor() public {
        ...
        tableFactory.createTable(TABLE_NAME, "fix_id", "tag_id,tag_name,data_resource_type,created_time,updated_time,ext_json");
    }
    ...
    function insert(string[] params, string ext_json) public returns (int) {
        ...
        entry.set("data_resource_type", params[2]);
        entry.set("created_time", params[3]);
        entry.set("updated_time", params[4]);
