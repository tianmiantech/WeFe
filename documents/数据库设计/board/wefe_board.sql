...
(
    ...
    `y_positive_example_ratio` double(10, 4) COMMENT '正例比例',
...
CREATE TABLE `project_flow_template` (
  ...
  `federated_learning_type` varchar(32) DEFAULT NULL COMMENT '联邦任务类型（横向/纵向）',
