...
当前版本不提供Docker的部署方案，只提供v3.8.6版本的Docker部署方案，如果想源码编译当前版本请参考原来系统架构下各模块的[源码编译方式。](../../README.md)
想快速搭建联邦学习平台请参考部署文档[deploy/WeFe隐私计算服务部署说明文档.md](../../deploy/WeFe隐私计算服务部署说明文档.md)
