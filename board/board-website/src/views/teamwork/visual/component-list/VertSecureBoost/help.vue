        ...
        <template #params>
            <ol>
                ...
                <li>工作模式：work_mode枚举值：normal、layered、skip。
                    ...
                    三个枚举值说明如下：
                    <br>
                    ① normal：promoter 跟 provider双方共同构建树结构。
                    <br>
                    ② layered：双方交替构建树结构，一方构建完某一层或多层后，再交由另一方构建，交替进行。
                    <br>
                    ③ skip：双方交替构建树结构，一方构建完一棵或多棵树后，再交由另一方构建，交替进行。
                    <br>
                    ④ dp: 新增参数：epsilon：隐私预算。epsilon越小，隐私保护越好，但加入的噪声 1/(e^epsilon + 最大桶数量 - 1) 越大，数据可用性下降。
                </li>
            </ol>
        </template>
        <template #desc>
