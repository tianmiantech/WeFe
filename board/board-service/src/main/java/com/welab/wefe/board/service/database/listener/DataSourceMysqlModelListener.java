...
public class DataSourceMysqlModelListener {
    /**
     * before save
     */
    @PrePersist
    public void prePersist(Object entity) throws StatusCodeWithException {
        if (null != entity) {
            DataSourceMysqlModel model = (DataSourceMysqlModel) entity;
            model.setPassword(DatabaseEncryptUtil.encrypt(model.getPassword()));
        }
    }
    ...
    public void postLoad(Object entity) throws StatusCodeWithException {
        if (null != entity) {
            DataSourceMysqlModel model = (DataSourceMysqlModel) entity;
            model.setPassword(DatabaseEncryptUtil.decrypt(model.getPassword()));
        }
    }
}
