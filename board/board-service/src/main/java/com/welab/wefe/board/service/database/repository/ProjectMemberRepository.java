 ...
 */
@Repository
public interface ProjectMemberRepository extends BaseRepository<ProjectMemberMySqlModel, String> {

    /**
     * 获取与我合作的所有成员
     */
    @Query(value = "select member_id from #{#entityName} group by member_id", nativeQuery = true)
