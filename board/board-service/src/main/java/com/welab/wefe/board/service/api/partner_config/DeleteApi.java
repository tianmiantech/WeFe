 ...
 * @date 2022/9/8
 */
@Api(path = "partner_config/delete", name = "删除合作方配置记录")
public class DeleteApi extends AbstractApi<DeleteApi.Input, DeleteApi.Output> {
    ...
    protected ApiResult<Output> handle(Input input) throws Exception {
        partnerConfigService.delete(input.id);
        return success();
    }
