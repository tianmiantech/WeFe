 ...
 * @date 2022/3/22
 */
@Api(path = "project/top", name = "设置项目置顶状态")
public class TopProjectApi extends AbstractNoneOutputApi<TopProjectApi.Input> {
    ...
    protected ApiResult handler(Input input) throws StatusCodeWithException {
        projectService.top(input.projectId, input.top);
        return success();
    }
