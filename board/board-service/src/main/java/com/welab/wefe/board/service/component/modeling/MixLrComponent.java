 ...
 */
@Service
public class MixLrComponent extends AbstractModelingComponent<MixLrComponent.Params> {

    @Override
    protected void checkBeforeBuildTask(FlowGraph graph, List<TaskMySqlModel> preTasks, FlowGraphNode node, Params params) {
