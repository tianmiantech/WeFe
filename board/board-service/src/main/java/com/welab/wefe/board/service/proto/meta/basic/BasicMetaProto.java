...
public final class BasicMetaProto {
  ...
  public interface KeyValueDataOrBuilder extends
      // @@protoc_insertion_point(interface_extends:com.welab.wefe.gateway.api.meta.basic.KeyValueData)
      com.google.protobuf.MessageOrBuilder {
  ...
  /**
   * Protobuf type {@code com.welab.wefe.gateway.api.meta.basic.KeyValueData}
   */
  public  static final class KeyValueData extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:com.welab.wefe.gateway.api.meta.basic.KeyValueData)
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return BasicMetaProto.internal_static_com_welab_wefe_gateway_api_meta_basic_KeyValueData_descriptor;
    }

    @Override
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return BasicMetaProto.internal_static_com_welab_wefe_gateway_api_meta_basic_KeyValueData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              KeyValueData.class, Builder.class);
    }
    ...
    public static KeyValueData parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static KeyValueData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static KeyValueData parseFrom(
    ...
    public static KeyValueData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static KeyValueData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static KeyValueData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(KeyValueData prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
        // @@protoc_insertion_point(builder_implements:com.welab.wefe.gateway.api.meta.basic.KeyValueData)
        KeyValueDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return BasicMetaProto.internal_static_com_welab_wefe_gateway_api_meta_basic_KeyValueData_descriptor;
      ...
      // Construct using com.welab.wefe.gateway.api.meta.basic.BasicMetaProto.KeyValueData.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public KeyValueData getDefaultInstanceForType() {
        return KeyValueData.getDefaultInstance();
      }

      @Override
      public KeyValueData build() {
        KeyValueData result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @Override
      public KeyValueData buildPartial() {
        KeyValueData result = new KeyValueData(this);
        result.key_ = key_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof KeyValueData) {
          return mergeFrom((KeyValueData)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(KeyValueData other) {
        if (other == KeyValueData.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        KeyValueData parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (KeyValueData) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
    ...
    throw new NullPointerException();
      ...
      // @@protoc_insertion_point(builder_scope:com.welab.wefe.gateway.api.meta.basic.KeyValueData)
    }

    // @@protoc_insertion_point(class_scope:com.welab.wefe.gateway.api.meta.basic.KeyValueData)
    private static final KeyValueData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new KeyValueData();
    }
  ...
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_com_welab_wefe_gateway_api_meta_basic_KeyValueData_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_com_welab_wefe_gateway_api_meta_basic_KeyValueData_fieldAccessorTable;
  ...
  static {
    String[] descriptorData = {
      ...
      "yValueData\022\013\n\003key\030\001 \001(\014\022\r\n\005value\030\002 \001(\014B\020" +
      "B\016BasicMetaProtob\006proto3"
    };
    ...
    internal_static_com_welab_wefe_gateway_api_meta_basic_KeyValueData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_com_welab_wefe_gateway_api_meta_basic_KeyValueData_descriptor,
