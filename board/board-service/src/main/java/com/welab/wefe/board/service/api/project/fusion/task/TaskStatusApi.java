...
public class TaskStatusApi extends AbstractApi<TaskStatusApi.Input, EnumSet<FusionTaskStatus>> {
    ...
    @Override
    protected ApiResult<EnumSet<FusionTaskStatus>> handle(Input input) throws StatusCodeWithException {
        EnumSet<FusionTaskStatus> statuses = EnumSet.allOf(FusionTaskStatus.class);
