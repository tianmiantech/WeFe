 ...
 **/
@Repository
public interface ChatLastAccountRepository extends BaseRepository<ChatLastAccountMysqlModel, String> {

    int deleteByAccountIdEqualsAndLiaisonAccountIdEquals(String accountId, String liaisonAccountId);
}
