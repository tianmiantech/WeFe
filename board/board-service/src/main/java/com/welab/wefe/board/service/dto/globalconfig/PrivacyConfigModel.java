 ...
 * @date 2022/5/31
 */
@ConfigModel(group = ConfigGroupConstant.PRIVACY_CONFIG)
public class PrivacyConfigModel extends AbstractConfigModel {
    @Check(name = "数据库是否已加密完成")
    public boolean databaseEncryptCompleted;
}
