 ...
 * @author yuxin.zhang
 **/
@Api(path = "data_resource/tags/query", name = "data_resource_tags_query")
public class DataResourceTagsApi extends AbstractApi<DataResourceTagsApi.Input, List<TagsDTO>> {
    @Autowired
    protected DataResourceMongoReop dataResourceMongoReop;

    @Override
    protected ApiResult<List<TagsDTO>> handle(DataResourceTagsApi.Input input) throws StatusCodeWithException, IOException {
