...
public class AbstractContractService {
    ...
    protected boolean transactionIsSuccess(TransactionResponse transactionResponse) throws StatusCodeWithException {
    ...
    protected boolean transactionDataNotFound(String responseValues) {
        JSONArray values = JObject.parseArray(responseValues);
        return !transactionException(responseValues) && (values.getIntValue(0) == -3);
    }
