...
package com.welab.wefe.manager.service.api.auth;
 ...
 * @author yuxin.zhang
 **/
@Api(path = "member/realname/authInfo/query", name = "member_query", login = false)
public class RealNameAuthInfoQueryApi extends AbstractApi<MemberQueryInput, PageOutput<MemberQueryOutput>> {
    @Autowired
