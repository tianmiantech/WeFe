...
import com.welab.wefe.common.data.mongodb.repo.OperationLogMongoRepo;
...
public class ManagerApiLogger extends AbstractApiLogger {
    ...
    @Autowired
    private OperationLogMongoRepo operationLogMongoRepo;
    ...
    protected void save(ApiLog apiLog) throws Exception {
        ...
        operationLogMongoRepo.save(model);
    }
